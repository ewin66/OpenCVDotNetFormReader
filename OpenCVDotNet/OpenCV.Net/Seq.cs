...
namespace OpenCV.Net
{
    ...
    {
        internal static readonly Seq Null = new SeqNull();
        MemStorage owner;
        ...
        internal Seq(MemStorage storage)
            : base(true)
        {
            owner = storage;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Seq"/> class from a specified
        ...
        internal Seq(bool ownsHandle)
            : base(ownsHandle)
        {
        }

        /// <summary>
        /// Gets the size of the <see cref="Seq"/> header, in bytes.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="MemStorage"/> where the sequence is stored.
        /// </summary>
        ...
        {
            CopyTo(array, SeqSlice.WholeSeq);
        }
        ...
        public void CopyTo<TElement>(TElement[] array, SeqSlice slice) where TElement : struct
        {
        ...
        /// </param>
        /// <returns>
        /// A new <see cref="Seq"/> instance containing the elements in the
        ...
        /// </summary>
        /// <param name="storage">
        /// The destination <see cref="MemStorage"/> instance on which to store the new sequence.
        /// If <paramref name="storage"/> is <b>null</b>, the same memory storage of this sequence is used.
        /// </param>
        /// <returns>A new <see cref="Seq"/> instance that is a copy of this sequence.</returns>
        public Seq Clone(MemStorage storage = null)
        {
            return Slice(SeqSlice.WholeSeq, storage, true);
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="Seq"/> handle.
        /// </summary>
        /// <returns>
